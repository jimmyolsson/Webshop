...
namespace Webshop.Infrastructure.Security.Identity.Stores
{
		...
		where TRoleClaim : ApplicationIdentityRoleClaim<TKey>
	{
		...
		public async Task<TRole> FindByIdAsync(string roleId, CancellationToken cancellationToken)
		{
			...
			try
			{
				var result = await _roleRepository.GetByIdAsync(ConvertIdFromString(roleId), cancellationToken);
		...
		public async Task<TRole> FindByNameAsync(string normalizedRoleName, CancellationToken cancellationToken)
		{
			...
			try
			{
				var result = await _roleRepository.GetByNameAsync(normalizedRoleName, cancellationToken);
